...
export default function Header() {
  ...
  return (
    <header className=" bg-color-secondary-1">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-6 xs:px-8">
        <Link to="/">
          <svg
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex h-10 w-24 items-center justify-center rounded-lg bg-color-secondary-3 p-2 shadow-sm transition hover:bg-color-secondary-2">
            <SlUser className="mr-2 text-white" />
          ...
          <Popover className="relative">
            {({ open }) => (
              <>
                ...
                >
                  <Popover.Panel className="sm:px-0 absolute right-0 z-10 mt-3 w-screen max-w-xs transform px-4">
                    <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                      <div className="relative grid gap-6 bg-white p-6">
                        <div className="-m-3 flex cursor-pointer items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-color-support-1 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50">
                          <div className="sm:h-8 sm:w-12 flex h-10 w-10 shrink-0 items-center justify-center text-white">
                        ...
                        <div className="-m-3 flex cursor-pointer items-center justify-between rounded-lg p-2 transition duration-150 ease-in-out hover:bg-color-support-1 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50">
